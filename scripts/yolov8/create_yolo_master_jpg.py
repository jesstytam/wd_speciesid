def update_text_file(dataset):
    ...
    input_file = '/home/jess2/wd_speciesid/data/processed/yolo/' + dataset + '/' + dataset + '.txt'
    output_file = '/home/jess2/wd_speciesid/data/processed/yolo/' + dataset + '/' + dataset + '_jpg.txt'
