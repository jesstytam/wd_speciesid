def update_text_file(dataset):
    ...
    input_file = '/home/jess/wd_speciesid/data/processed/yolo/' + dataset + '/' + dataset + '.txt'
    output_file = '/home/jess/wd_speciesid/data/processed/yolo/' + dataset + '/' + dataset + '_jpg.txt'
